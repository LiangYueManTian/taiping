 ...
 */
@Component
public class UpsElectricAnalyze extends AbstractCapacityAnalyze {
    ...
    protected CapacityAnalyzeData analyzeDataRealize(Map<String, List<SystemSetting>> searchCapacityThresholdList, Integer analysisYear, Integer analysisMonth) {
        return itEnergyAnalyze.getAnalyzeData(searchCapacityThresholdList, analysisYear, analysisMonth, ThresholdTypeEnum.UPS);
    }
